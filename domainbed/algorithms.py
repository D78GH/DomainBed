...
class MLPMCL(ERM):
    ...
    def __init__(self,input_shape,num_classes,num_domains,hparams):
        super().__init__(input_shape,num_classes,num_domains,hparams)
        self.num_classes=num_classes
        self.num_prototypes=hparams.get("num_prototypes",1)
...
class MLPMCL_softmax(ERM):
    ...
    Multiple Learnable Prototype Memory Contrastive Learning
    Inspired by learnable prototypes: Li et al, Prototype Memory and Contrastive Learning Based Unsupervised Anomaly Detection for Time Series, 2026
    Uses a learned softmax weighting for prototype contrastive learning loss formula
...
class MLDPMCL_softmax(ERM):
    """
    Multiple Learnable Diverse Prototype Memory Contrastive Learning
    Inspired by learnable prototypes: Li et al, Prototype Memory and Contrastive Learning Based Unsupervised Anomaly Detection for Time Series, 2026
    Uses a learned softmax weighting for prototype contrastive learning loss formula
    Supplemented by a prototype diversity loss to encourage within-class diversity by learning distinct class-specific prototypes, with a small regularisation weight (0.001) to prevent prototype collapse
